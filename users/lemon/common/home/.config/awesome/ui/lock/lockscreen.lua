...
awful.spawn.easy_async_with_shell("convert " .. b.wallpaper .. " -filter Gaussian -blur 0x6 -fill 222222c1 -colorize 50% " .. gears.filesystem.get_cache_dir() .. "lock.jpg", function()
