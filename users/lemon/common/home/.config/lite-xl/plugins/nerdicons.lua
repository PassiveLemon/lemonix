...
local extension_icons = {
  ...
  [".ino"]        = { "#008184", "linux-arduino"           },
  [".zip"]        = { "#4caf50", "md-zip_box"              },
  [".gz"]         = { "#4caf50", "md-zip_box"              },
  [".xz"]         = { "#4caf50", "md-zip_box"              },
  [".scm"]        = { "#aaaaaa", "custom-scheme"           },
}
...
local known_filenames_icons = {
  ...
  [".git-blame-ignore-revs"] = { "#f05032", "seti-git"            },
  ...
  [".dockerignore"]          = { "#2496ef", "linux-docker"        },
  [".env"]                   = { "#6d8086", "seti-config"         },
}
