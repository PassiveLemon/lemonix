...
local space = helpers.text(" ", beautiful.font, "center")

local cpu_text = helpers.text("CPU", beautiful.font, "center")
...
local mem_text = helpers.text("Memory", beautiful.font, "center")
...
local network_text = helpers.text("Network", beautiful.font, "center")
...
local gpu_text = helpers.text("GPU", beautiful.font, "center")
...
local strg_text = helpers.text("Storage", beautiful.font, "center")
